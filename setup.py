#!/usr/bin/env python
# This file is part purchase_payment_type module for Tryton.
...
setup(name=name,
    version=version,
    description='Tryton Purchase Payment Type Module',
    ...
    packages=[
        ...
        'trytond.modules.purchase_payment_type.tests',
        ],
    package_data={
        'trytond.modules.purchase_payment_type': (info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    purchase_payment_type = trytond.modules.purchase_payment_type
    """,
    test_suite='tests',
